...
<a href="index.php" style="all:unset; cursor:pointer; color:white; text-decoration:underline;">Back To Calendar</a><br/></br><br/>
...
if (isset($events) && count($events) > 0) {
    ...
    echo '<p style="color: white;">No Events Created</p>';
}
?>
